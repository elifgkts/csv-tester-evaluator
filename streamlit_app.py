# -*- coding: utf-8 -*-
# 📌 Test Case Evaluator v1.6.1 – Data puanlaması: JSON 'Data' alanını da kabul et
...
def has_data_present_for_scoring(steps_text:str) -> bool:
    ...
    - JSON içinde "Data": "<boş olmayan>" alanı VARSA (örn. "ISBN\nPostman")
    - 'none', 'n/a', '-', 'yok' gibi anlamsız değerler sayılmaz
    """
    if has_data_tag(steps_text):
        return True

    # JSON benzeri tüm "Data" alanlarını tara
...
def decide_data_needed(summary:str, steps_text:str):
    ...
    - Eğer 'Data:' etiketi **veya** JSON'da 'Data' alanı doluysa → doğrudan GEREKLİ.
...
def score_one(row):
    ...
    # 3) Data – **güncellendi**: etiket VEYA JSON 'Data' alanı
    if 3 in active:
