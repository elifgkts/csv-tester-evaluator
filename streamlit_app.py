# -*- coding: utf-8 -*-
# 📌 Test Case Evaluator v1.7-UI – Görsel iyileştirmeler (KPI kartları, progress bar, sidebar, şık detaylar)
...
.app-hero h1 {
  font-size: 24px; margin: 0 0 6px 0; line-height: 1.2;
}
.app-hero p {
...
if uploaded:
    ...
    # ---------- Skor yüzdesi + tablo ----------
    # Her tablo için maksimum puanlar
